...
#include "../minishell.h"
/*tcgetattr -  this gets the current attributes of the terminal and has error handling*/
/*term_state.c_lflag &= ~ECHOCTL - using bitwise operations this disables echoing*/
/*tcsetattr - this is what sets the attributes now that we have changed to dont echo*/
/*called from main*/
